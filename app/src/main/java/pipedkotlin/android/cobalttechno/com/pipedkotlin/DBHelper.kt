...
class DBHelper(ctx: Context) : ManagedSQLiteOpenHelper(ctx, "PipedDatabase", null, 2)
{
    ...
    override fun onCreate(db: SQLiteDatabase?) {
        ...
        // Prev PE
        db!!.createTable(EXLDPrevPE.TABLE_NAME, true,
                EXLDPrevPE.COLUMN_ID to INTEGER + PRIMARY_KEY + AUTOINCREMENT,
                EXLDPrevPE.COLUMN_PROCESS_ID to INTEGER + DEFAULT("0"),
                EXLDPrevPE.COLUMN_PE_TEST_ABORTED to INTEGER + DEFAULT("0"),
                EXLDPrevPE.COLUMN_PE_WATER_VOLUME to REAL + DEFAULT("0"),
                EXLDPrevPE.COLUMN_PREV_PE_ID to INTEGER + DEFAULT("0"),
                EXLDPrevPE.COLUMN_PREV_PE_PROCESS_ID to INTEGER + DEFAULT("0"),
                EXLDPrevPE.COLUMN_START_PRESSURE to REAL + DEFAULT("0"),
                EXLDPrevPE.COLUMN_SYSTEM_TEST_PRESSURE to REAL + DEFAULT("0"),
                EXLDPrevPE.COLUMN_PRESSURISING_START to TEXT + DEFAULT("''"),
                EXLDPrevPE.COLUMN_PRESSURISING_FINISH to TEXT + DEFAULT("''"),
                EXLDPrevPE.COLUMN_READING_1 to REAL + DEFAULT("0"),
                EXLDPrevPE.COLUMN_READING_2 to REAL + DEFAULT("0"),
                EXLDPrevPE.COLUMN_READING_3 to REAL + DEFAULT("0"),
                EXLDPrevPE.COLUMN_READING_4 to REAL + DEFAULT("0"),
                EXLDPrevPE.COLUMN_READING_5 to REAL + DEFAULT("0"),
                EXLDPrevPE.COLUMN_READING_TIME_1 to TEXT + DEFAULT("''"),
                EXLDPrevPE.COLUMN_READING_TIME_2 to TEXT + DEFAULT("''"),
                EXLDPrevPE.COLUMN_READING_TIME_3 to TEXT + DEFAULT("''"),
                EXLDPrevPE.COLUMN_READING_TIME_4 to TEXT + DEFAULT("''"),
                EXLDPrevPE.COLUMN_READING_TIME_5 to TEXT + DEFAULT("''"),
                EXLDPrevPE.COLUMN_CALC_RESULT to REAL + DEFAULT("0"),
                EXLDPrevPE.COLUMN_LAT to REAL + DEFAULT("0"),
                EXLDPrevPE.COLUMN_LONG to REAL + DEFAULT("0"),
                EXLDPrevPE.COLUMN_PASS to REAL + DEFAULT("0"),
                EXLDPrevPE.COLUMN_NOTES to TEXT + DEFAULT("''"),
                EXLDPrevPE.COLUMN_PDF_LOG_PA_T1 to REAL + DEFAULT("0"),
                EXLDPrevPE.COLUMN_PDF_LOG_PA_T2 to REAL + DEFAULT("0"),
                EXLDPrevPE.COLUMN_PDF_LOG_PA_T3 to REAL + DEFAULT("0"),
                EXLDPrevPE.COLUMN_PDF_LOG_PA_T4 to REAL + DEFAULT("0"),
                EXLDPrevPE.COLUMN_PDF_LOG_PA_T5 to REAL + DEFAULT("0"),
                EXLDPrevPE.COLUMN_LOG_T1 to REAL + DEFAULT("0"),
                EXLDPrevPE.COLUMN_LOG_T2 to REAL + DEFAULT("0"),
                EXLDPrevPE.COLUMN_LOG_T3 to REAL + DEFAULT("0"),
                EXLDPrevPE.COLUMN_LOG_T4 to REAL + DEFAULT("0"),
                EXLDPrevPE.COLUMN_LOG_T5 to REAL + DEFAULT("0"),
                EXLDPrevPE.COLUMN_PDF_PASS to INTEGER + DEFAULT("0"),
                EXLDPrevPE.COLUMN_PDF_CALC_RESULT to REAL + DEFAULT("0"),
                EXLDPrevPE.COLUMN_PDF_N1 to REAL + DEFAULT("0"),
                EXLDPrevPE.COLUMN_PDF_N2 to REAL + DEFAULT("0"),
                EXLDPrevPE.COLUMN_PDF_N3 to REAL + DEFAULT("0"),
                EXLDPrevPE.COLUMN_PDF_N4 to REAL + DEFAULT("0"),
                EXLDPrevPE.COLUMN_PIPE_LENGTH to TEXT + DEFAULT("''"),
                EXLDPrevPE.COLUMN_PIPE_DIAMETER to INTEGER + DEFAULT("0"),
                EXLDPrevPE.COLUMN_INSTALLATION_TECH to TEXT  + DEFAULT("''"),
                EXLDPrevPE.COLUMN_PUMP_SIZE to TEXT + DEFAULT("''"),
                EXLDPrevPE.COLUMN_LOGGER_DETAILS to TEXT + DEFAULT("''"),
                EXLDPrevPE.COLUMN_PT_PE_READINGS_COUNT to INTEGER + DEFAULT("0")
                )
